...
import { updateNewExpense } from '../../postdata/postdata';
            ...
            <form onSubmit={AddExpense}>
                <div className="row">
                    ...
                    <div className="col-sm-6">
                        ...
                        <input className='student-name-input-field form-control' type="file" name="bill"
                            onChange={handleImage} />
                        <p className='make-payment-email-address'>
                                <a className='text-decoration-none' href={`${secondbaseUrl}${expensedata.bill}`}
...
export default UpdatedEditExpense;